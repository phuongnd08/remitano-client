...
describe Remitano::Trades do
  describe :active, vcr: {cassette_name: 'remitano/trades/active'} do
    describe "first trade" do
      subject { Remitano::Trades.of_coin("btc", config: Remitano.default_config).active("sell").trades.first }
  ...
  describe :completed, vcr: {cassette_name: 'remitano/trades/completed'} do
    describe "first trade" do
      subject { Remitano::Trades.of_coin("btc", config: Remitano.default_config).completed("sell").trades.first }
  ...
  describe :release, vcr: {cassette_name: 'remitano/trades/release'} do
    it "release the trade" do
      Remitano::Trades.of_coin("btc", config: Remitano.default_config).release("2T61603008")
      trade = Remitano::Trades.of_coin("btc", config: Remitano.default_config).get("2T61603008")
